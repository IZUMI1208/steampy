...
one_time_authentication_code = generate_one_time_code(jSFM+54e0U6wmyDYGTMFQyu4LCs=)
print(one_time_authentication_code)

confirmation_key = generate_confirmation_key(LgW1o15aeJmwnRO8C/pwgO75/4Q=, 'conf')
